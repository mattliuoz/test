...
{
    public class CaulfieldRaceDataConnector : RaceDataConnector
    {
        private readonly RaceDataSourceConfig _config;
        const string RACE_FIELD_NAME = "Caulfield";
        public CaulfieldRaceDataConnector(RaceDataSourceConfig config) : base(config)
        {
            _config = config;
        }
